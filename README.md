...
Hey! I built this app for my family. Not just as a side project, but as something we actually use every day. This app is running on a tablet mounted in our kitchen that keeps the whole household in sync without anyone having to think about it.

The deeper motivation was to get hands-on with the full stack: frontend, backend, database, cloud deployment, Android distribution, as well as make some consumer-ish product decisions that I don't get to practice in my B2B product career. It was also a great way to get really chummy with Claude Code.

---

## The problem it solves

We ran a busy household. Between commutes, daycare, groceries, etc. everyone is trying to answer recurrent questions at the same time: what events are on the shared calendar for the next week, do I need an umbrella, is the train delayed, do we need to pick something up at Costco? The answer used to be scattered across N apps and two people's phones.

This custom tailored app puts all of it on one screen, always on, always up to date, visible to the whole family at a glance while having breakfast. 

---

## What it shows

- **Upcoming events** — pulled live from the family Google Calendar. Birthdays, school pickups, playdates, appointments, anything the family has scheduled
...
- **BART departures** — live transit times from our Bart station to Downtown San Francisco, so we know exactly when to leave to catch the train
...
**It was hard to find the balance between adding useful features vs scope creep**
